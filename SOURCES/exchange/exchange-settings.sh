...
export DISABLE_BOUNDLESS_LINK_IN_FOOTER=${DISABLE_BOUNDLESS_LINK_IN_FOOTER:-'False'}
export MAP_CLIENT_USE_CROSS_ORIGIN_CREDENTIALS=${MAP_CLIENT_USE_CROSS_ORIGIN_CREDENTIALS:-'False'}
