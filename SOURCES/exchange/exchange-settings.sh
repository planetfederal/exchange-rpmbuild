...
export GEOSERVER_DATA_DIR='/opt/boundless/exchange/geoserver_data'
export GEOSERVER_LOG='/opt/boundless/exchange/geoserver_data/logs/geoserver.log'
export GEOGIG_DATASTORE_DIR='/opt/boundless/exchange/geoserver_data/geogig'
